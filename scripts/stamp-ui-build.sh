...
sed -i '' "s|/logo.js?v=[0-9]*|/logo.js?v=$BUILD|g" "$TARGET"
sed -i '' "s|/launch-splash.js?v=[0-9]*|/launch-splash.js?v=$BUILD|g" "$TARGET"
sed -i '' "s|/launch-splash-layout.css?v=[0-9]*|/launch-splash-layout.css?v=$BUILD|g" "$TARGET"
sed -i '' "s|/logo-animated.css?v=[0-9]*|/logo-animated.css?v=$BUILD|g" "$TARGET"
